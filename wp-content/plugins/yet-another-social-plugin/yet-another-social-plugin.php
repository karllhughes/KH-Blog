				...
				<div id="side-sortables" class="meta-box-sortables">
					...
					<div class="handlediv" title="Click to toggle"><br /></div>
						...
						<div class="inside">		
							...
							<span><a href="http://www.facebook.com/pages/How-To-Tutorials-Triptrip-Tips/233542810083158" title="Our Facebook page" target="_blank"><img style="border:1px #ccc solid;" src="<?php echo plugins_url(); ?>/yet-another-social-plugin/images/facebook-icon.png" /></a></span>
							&nbsp;&nbsp;<span><a href="http://twitter.com/Triptrippertips" title="Follow on Twitter" target="_blank"><img style="border:1px #ccc solid;" src="<?php echo plugins_url(); ?>/yet-another-social-plugin/images/twitter-icon.png" /></a></span>
...
function yasp_buttons($content) {
	...
	<div id="pinterest-wrapper" style="width: 70px; margin-top: 17px!important; float: left;"><a href="http://pinterest.com/pin/create/button/?url='.get_permalink($post->id).'&media='. $catch_thumb.'&description=' . $yasptitle . ' on ' . $yasplink . '" class="pin-it-button" count-layout="vertical">Pin It</a></div>
	...
	$clearfix = '<div class="yaspclearfix" style="clear: both; padding:3px 0;"></div>';
        if ( 'post' == get_post_type() ) {
            	$clearfix .= '<div class="google_ad">
...
if(!is_feed() && !is_home() && !is_page( $exclude_pages )) if ( isset($options['chek_button1']) && ($options['chek_button1']!="") ) 
